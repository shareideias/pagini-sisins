...
class Redacao1View(private val errormsg: String?, private val participante: Participante, private val cursos: Curso, private var interruptor: Int) : SisInsAlunoView() {
    ...
    override fun BODY.renderBody(ctx: Context) {
        ...
        div("container center col s12") {
            ...
            form("CadastraCurso1", classes = "col s12 center", method = FormMethod.post) {
